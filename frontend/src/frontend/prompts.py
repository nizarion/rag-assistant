...
class UIPrompts:
    ...
    welcome: str = "Hello! I'm your RAG Assistant. How can I help you learn about your shipping company today?"
...
class ActionLabels:
    ...
    populate_kb_desc: str = "Load or reload the knowledge base"
